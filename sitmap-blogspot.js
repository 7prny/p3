...
function displayToc(filter) {
    ...
    for (var i = 0; i < postTitle.length; i++) {
        if (filter == '') {
            tocTable += '<tr><td class="toc-entry-col1"><a href="' + postUrl[i] + '" title="' + postSum[i] + '">' + postTitle[i] + '</a></td><td class="toc-entry-col2">' + postDate[i] + '</td><td class="toc-entry-col3"><a href="/search/label/' + encodeURIComponent(postLabels[i]) + '">' + postLabels[i] + '</a></td></tr>';
            numDisplayed++;
        } else {
